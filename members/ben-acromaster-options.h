...
#define BOARD_TYPE 							RED_GREEN_BOARD
...
#define RACING_MODE_WP_THROTTLE				0.5
...
#define PITCHGAIN							0.04 // 0.150
#define PITCHKD								0.02 // 0.075
#define RUDDER_ELEV_MIX						0.03
